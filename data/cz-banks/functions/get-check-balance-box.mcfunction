...
#Get Balance Box
give @s minecraft:command_block{display:{Name:"{\"text\":\"Get Balance Box\",\"color\":\"green\",\"italic\":\"true\"}",Lore:["Used to manually check balance"]},BlockEntityTag:{Command:"/execute as @p run function cz-banks:required/check-balance"}} 1